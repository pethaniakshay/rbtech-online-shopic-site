...
?>
    ...
    <title>Add Sub Category | R.B.Tech Admin</title>
                        ...
                        <div class="col-sm-12">
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Add Sub Category</label>

                                        <div class="col-md-8">
                                            <input id="pname" name="sub_category" placeholder="Add Sub Category"
                            ...
                            if (isset($_POST["submitsubcategory"])) {
                                ...
                                mysqli_query($link,"insert into sub_category (id,main_category_id,sub_category_name)values (NULL,'$main_category_id','$sub_category_name1')") or die(mysqli_errno($link));
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table">
                                ...
                                $res = mysqli_query($link,"select * from sub_category");
                                ...
                                while ($row = mysqli_fetch_array($res))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php $res1=mysqli_query($link,"select * from main_category where id='$main_category_id'");
                                            while ($row1 = mysqli_fetch_array($res1))
                                            {
                                                echo $row1['main_category_name'];
                                            }
                                        ...
                                        <td><a href="edit-sub-category.php?id=<?php echo $id; ?>" class="btn btn-primary">Edit</a></td>
                                        <td><a href="del-sub-category.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a></td>
